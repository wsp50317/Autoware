...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.7.1 on Wed Nov 28 16:17:36 2018
#
...
class MyFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_2 = wx.Button(self.tab_simulation, wx.ID_ANY, _("LGSVL_Simulator"))
		...
		self.Bind(wx.EVT_BUTTON, self.OnLgsvlSimLaunch, self.button_2)
	...
	def __do_layout(self):
		...
		sizer_94.Add(self.button_points_image, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.EXPAND, 0)
		sizer_94.Add(self.button_virtual_scan_image, 1, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.EXPAND, 0)
		...
		sizer_47_copy.Add(self.button_gazebo, 0, wx.ALL, 4)
		sizer_47_copy.Add(self.button_2, 0, wx.ALIGN_CENTER, 0)
		sizer_62_copy_copy_copy_copy_copy.Add(sizer_47_copy, 1, wx.EXPAND, 0)
	...
	def OnLgsvlSimLaunch(self, event):  # wxGlade: MyFrame.<event_handler>
		print "Event handler 'OnLgsvlSimLaunch' not implemented!"
		event.Skip()
